                ...
                <div className="tw-flex tw-flex-1 tw-flex-col-reverse md:tw-flex-row tw-mx-auto tw-gap-8 tw-justify-between">
                  <div className="tw-flex tw-flex-col tw-gap-4 tw-flex-grow md:tw-max-w-[40%]">
                      ...
                      <div className="tw-flex tw-items-center tw-gap-2">
                        ...
                        >
                          <a
                            target="_blank"
                            rel="noopener noreferrer"
                             href="https://discord.com/invite/astralsnft"
                          >
                            <img
                        ...
                        >
                          <a
                            target="_blank"
                            rel="noopener noreferrer"
                            href="https://twitter.com/Astrals_NFT"
                          >
                            <img
                    ...
                    <p className="tw-mb-4 tw-text-gray-light">
                                                        1555 unique 3d avatars,
                                                        250 traits, 16 races. Astrals Vers is a community-driven project
                                                        with aspirations of galactic proportions featuring the incredible
                                                        character design art of Damien Guimoneau.
                                                        Each Astral is your gateway to our Galaxy DAO and to stake to mine $GLXY - our governance token
                    ...
                    <div className="tw-flex tw-flex-col tw-gap-4 tw-flex-grow md:tw-w-[40%]">
                      ...
                      <div>
                        ...
                        <p className="tw-text-gray-light tw-mb-3 tw-text-[16] tx-line-[24]">
                                                                ...
                                                                Mission: Incubate projects that are building exciting and innovative
                                                                technologies in the blockchain industry.
                        </p>
                      </div>
                    </div>
                        ...
                        <div className="tw-p-4">
                          ...
                          <div className="tw-my-1">
                            <p className="tw-text-gray-light tw-text-md tw-text-[14px]">
                                                                        ...
                                                                        Phase 2 is when we will begin to unveil the project vision,
                                                                        plan, team, partnerships, and value proposition.
                          ...
                          <div className="tw-my-1">
                            <p className="tw-text-gray-light tw-text-md tw-text-[14px]">
                                                                        ...
                                                                        We are planning a secret event as well that will be available for Loyals to attend.
                            </p>
                            <br />
                          </div>
                          <div className="tw-my-1">
